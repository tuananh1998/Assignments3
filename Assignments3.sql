...
-- INSERT TABLE Trainee
 ...
 -- question 2
	...
	SELECT    MONTH(Birth_Date) AS THÁNG,COUNT(TraineeID) AS SỐNGƯỜI
    FROM      Trainee
    GROUP BY MONTH(Birth_Date);
    
-- question 3

    SELECT    	TraineeID,Full_Name,Birth_Date,Gender,ET_IQ,ET_Gmath,ET_English,Training_Class,Evaluation_Notes,VTI_Account
    FROM     	Trainee
...
-- question 6
	...
	UPDATE Trainee SET TraineeID = 2 WHERE TraineeID = 5;
